...
export function FolderCreator ({ onCreateFolder }:any){
  ...
  return (
    <button onClick={() => setIsCreating(true)} style={{ background: '#333', color: '#fff', border: 'none', borderRadius: '4px', padding: '6px 12px', cursor: 'pointer', fontSize: '12px', flexShrink: 0 }}>
      ➕
    </button>
  );
};
